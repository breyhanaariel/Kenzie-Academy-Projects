...
let snackcount = prompt("How many of this snack would you eat in a day?");
...
let daystill100 = (100 - age) * 365;
let lifetimesnack = daystill100 * snackcount;
...
document.write(
    "Congratulations, you have won a lifestime supply of " +
      favoritesnack +
      "! You will receive " +
      snackcount  + " " + favoritesnack +
      " per day, for a grand total of " +
      lifetimesnack  + " " + favoritesnack
);
